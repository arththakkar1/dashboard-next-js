    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative z-10 mx-4 mt-4 sm:mt-0 w-full max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto rounded-2xl border border-border bg-card shadow-2xl [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            role="dialog"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="flex items-center gap-3 border-t border-border pt-5">
                ...
                <button
                  type="submit"
                  className="flex-1 cursor-pointer rounded-xl bg-primary px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary-dark hover:scale-[1.02] active:scale-[0.98]"
                >
                  Add Item
                </button>
              </div>
